...
function ProjectorGradientMesh() {
  ...
  const fragmentShader = `
    ...
    void main() {
      ...
      gradientShaderUv2.xy += uTime * 0.03;
      gradientShaderUv2 = rotateUV(gradientShaderUv2, uTime * 0.03);
      ...
      float colorCycle = sin(uTime * 0.1) * 0.5 + 0.5;  // 0-1でゆっくり往復
      ...
      color = mix(color * 0.6, color * 1.3, gradientUV.y);
